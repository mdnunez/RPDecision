%% this script gets you the RP and P300 stimulus-locked for each subject (Figure 3b; Figure 4)
clear all
erpwindow = [-400:1500];
erpbaseline = [200:400];
...
eval(['save -v7.3 ' subid '/' subid '_motorerp_stimlocked.mat erp whichtrials' ]);
