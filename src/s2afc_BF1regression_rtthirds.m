%s2afc_bf1regression_rtthirds.m - Calculates Bayes Factors for simple regression models with RP durations
%
...
%   ====        =================            =====================
%  01/16/18        Michael Nunez             Adapted from pdm5b_simplemodels.m
%                                          & regression_rtthirds.m
%  10/20/20        Michael Nunez           Fixed model comments
%  10/23/20        Michael Nunez             Fit all models
