function [erp,ntrials] = motorERP(data,responsetime,trials,window,whichtrials);
...
erp.eo.left = erp.eo.left + squeeze(data(window+responsetime(thetrial)+1000,:,thetrial));	
end;
...
erp.eo.right = erp.eo.right + squeeze(data(window+responsetime(thetrial)+1000,:,thetrial));	
end;
...
erp.as.left = erp.as.left + squeeze(data(window+responsetime(thetrial)+1000,:,thetrial));	
end;
...
erp.as.right = erp.as.right + squeeze(data(window+responsetime(thetrial)+1000,:,thetrial));	
end;
